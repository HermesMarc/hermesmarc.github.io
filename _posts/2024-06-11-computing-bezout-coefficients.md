...
Here is a more convenient and direct way to compute the Bézout coefficients (known as _Blankinship's algorithm_ [1]).
...
_Proof._ We will do a proof by induction on the product $n = \min(a,b)$.
